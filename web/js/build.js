// build.js - generate a complete, correct card.
//
 ...
 * @property {string} path   card-relative POSIX path
 ...
 * @param {Record<string,string>} [patches] bundled example patches, `{"chuck/0.ck": "...", ...}`
 * @returns {{dirs: string[], files: CardFile[]}}
 */
export function buildCard(layout, patches = {}) {
  /** @type {CardFile[]} */
  const files = [];
 ...
 */
export function missingFrom(built, existingPaths) {
